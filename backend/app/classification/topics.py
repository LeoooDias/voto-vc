...
TOPICS = [
    ...
    TopicDef(
        "meio-ambiente",
        "Meio Ambiente",
        "Desmatamento, clima, fauna, flora, saneamento",
        "🌿",
        "#16A34A",
    ),
    TopicDef(
        "seguranca", "Seguranca Publica", "Policia, armas, sistema penal, violencia", "🛡️", "#475569"
    ),
    TopicDef(
        "direitos-humanos",
        "Direitos Humanos",
        "Direitos civis, minorias, igualdade",
        "⚖️",
        "#DB2777",
    ),
    TopicDef(
        "trabalho", "Trabalho", "Direitos trabalhistas, emprego, previdencia", "👷", "#CA8A04"
    ),
    TopicDef(
        "agricultura", "Agricultura", "Agronegocio, reforma agraria, alimentos", "🌾", "#65A30D"
    ),
    ...
    TopicDef(
        ...
        "Combate a corrupcao, transparencia publica",
        "🔍",
        "#B91C1C",
    ),
    TopicDef(
        "previdencia", "Previdencia", "Aposentadoria, INSS, reforma previdenciaria", "👴", "#78716C"
    ),
    TopicDef(
        "habitacao", "Habitacao", "Moradia, programas habitacionais, aluguel", "🏠", "#0891B2"
    ),
    TopicDef(
        "transporte", "Transporte", "Infraestrutura, mobilidade urbana, rodovias", "🚌", "#F59E0B"
    ),
